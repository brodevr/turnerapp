...
const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    { path: '/admin/appointments', label: t('admin.sidebar.appointments', { defaultValue: 'Turnos' }), icon: Calendar },
    { path: '/admin/patients', label: 'Historias Clínicas', icon: FileText },
    { path: '/admin/professionals', label: t('admin.sidebar.professionals', { defaultValue: 'Profesionales' }), icon: Briefcase },
    { path: '/admin/services', label: t('admin.sidebar.services', { defaultValue: 'Servicios' }), icon: Briefcase },
    { path: '/admin/schedule', label: 'Horarios', icon: Clock },
    { path: '/admin/blocking', label: 'Bloqueos', icon: CalendarX },
    { path: '/admin/calendar', label: 'Calendario', icon: CalendarDays },
    { path: '/admin/payment-settings', label: 'Pagos / Seña', icon: CreditCard },
  ];
