...
export const ClientAuthProvider = ({ children }) => {
  ...
  const updateClientUser = (user) => setClientUser(user);

  return (
    <ClientAuthContext.Provider value={{ clientUser, isLoading, login, register, googleLogin, logout, updateClientUser }}>
      {children}
