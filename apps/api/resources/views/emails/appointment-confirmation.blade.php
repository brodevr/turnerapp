...
<head>
    ...
    <title>Confirmacion de Turno - Virginia Rojas Beauty</title>
</head>
<body style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f8f8f8; color: #333; margin: 0; padding: 40px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
        <!-- Header -->
        <div style="background-color: #F08080; padding: 40px; text-align: center; color: #ffffff;">
            <h1 style="margin: 0; font-size: 28px;">Virginia Rojas Beauty</h1>
            <p style="margin-top: 10px; font-size: 16px; opacity: 0.9;">Tu turno fue reservado con exito</p>
        </div>

        <!-- Body -->
        <div style="padding: 40px;">
            <p style="font-size: 18px; line-height: 1.6;">Hola <strong>{{ $appointment->customer_name }}</strong>,</p>
            <p style="font-size: 16px; line-height: 1.6; color: #666;">Tu turno ha sido registrado correctamente. A continuacion te dejamos los detalles:</p>

            <!-- Appointment Details -->
            <div style="background-color: #fff9f9; border: 1px solid #ffe4e4; border-radius: 12px; padding: 25px; margin: 30px 0;">
                <h2 style="margin: 0 0 15px 0; color: #F08080; font-size: 20px;">Detalles de tu turno</h2>
                <table style="width: 100%; font-size: 15px;">
                    ...
                    <tr>
                        <td style="padding: 8px 0; color: #888;">Sena:</td>
                        <td style="padding: 8px 0; font-weight: bold; color: #e67e22;">${{ number_format($appointment->deposit_amount, 2, ',', '.') }} ARS ({{ $appointment->deposit_percentage }}%)</td>
                    </tr>
                    @endif
                </table>
            </div>
            ...
            <div style="background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 12px; padding: 20px; margin: 20px 0; text-align: center;">
                <p style="margin: 0; font-size: 15px; color: #856404;">
                    <strong>Pago pendiente:</strong> Tu turno se confirmara automaticamente una vez que se acredite el pago de la sena.
                </p>
            </div>
            @endif

            <p style="font-size: 14px; line-height: 1.6; color: #888; text-align: center; margin-bottom: 30px;">
                Ubicacion: Belgrano, CABA. <br>
                Si necesitas cancelar o reprogramar, hacelo con anticipacion.
            </p>
